        ...
        <div className="mx-auto max-w-2xl lg:max-w-4xl">
          ...
          <figure className="mt-10">
            <figcaption className="mt-10">
              {/* Contact Image */}
              <img className="mx-auto h-21 w-21 rounded-full" src="/../pictures/logo.jpg" alt="" />

              <div className="m-9 flex items-center justify-center space-x-3 text-base">
                {/* Contact Name and Position */}
                <div className="font-semibold text-gray-900">Tshwanelo Matlou</div>
                <svg viewBox="0 0 2 2" width="3" height="3" aria-hidden="true" className="fill-gray-900">
                  <circle cx="1" cy="1" r="1" />
                </svg>
                <div className="text-gray-600">Store Manager</div>
              </div>
